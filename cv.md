...
- Over $600k/year in cloud savings identified and delivered, using AI to build reliable internal tools, systems and processes.
...
- Production Kubernetes bill cut in half, with zero incidents.
...
Both Kubernetes clusters at Smarter Sorting, July to September 2026. Measure first, right-size reservations, retire what nothing calls, drain nodes one at a time. $19,574/month starting point; ~$140k/year saved today, ~$160k once the committed-use step lands. Zero downtime.
...
The support platform that replaced Salesforce Cases and support.smartersorting.com. Scope set on July 10, 2026; first version built in hours on July 22; live on July 23; Salesforce sunset on July 31. Email-to-ticket intake over the Gmail API, public help center, knowledge base, assignment, RBAC, rich replies and attachments. 65,003 tickets, 145,464 messages and 100 articles migrated from BigQuery snapshots.
- Priorities set from live usage data: 66% of inbound mail carries attachments, 4 agents own 88% of cases
- Three Cloud Run services and Cloud SQL, every deploy through Terraform with state in HCP Terraform
- Live chat and CSAT designed as the next step
...
- Chosen as the AI showcase at the February 2026 all-hands
...
- 37 tables under row-level security, 217 automated tests, security audit closed
...
- Cut both GKE clusters from $19,574/month: right-sized dozens of services, retired 38 dead services with owner sign-off, drained 9 of 18 production nodes one at a time, moved staging to Spot capacity on AMD. Production bill halved ($9,483 to $4,745); ~$140k/year saved today, ~$160k once the committed-use step lands. Zero downtime, zero incidents.
...
- Led company-wide MFA enforcement across Google Workspace for 600+ expert accounts plus employees and contractors, rolled out in three phased waves to limit disruption.
...
- Audited Slack licensing (148 billing-active of 251 purchased seats) and defined the guest model for hybrid workers; compiled the company-wide vendor inventory the procurement team was missing.
- Archived 690 meeting transcripts, highlights and notes from tl;dv into a locked-down shared drive ahead of the vendor cancellation, with a manifest of what the API could not export.
...
- Ran frontline support and the full identity lifecycle for 100+ users across 30+ systems, resolving ~370 requests in the first year.
...
- Embedded electronics, electronic fuel injection and advanced automotive diagnostics.
...
- Taught IT fundamentals, graphic design, Photoshop, PC assembly and maintenance, basic English and basic administration.
